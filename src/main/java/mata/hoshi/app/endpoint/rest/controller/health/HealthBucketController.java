...
import static mata.hoshi.app.file.hash.FileHashAlgorithm.NONE;
...
import mata.hoshi.app.file.bucket.BucketComponent;
import mata.hoshi.app.file.hash.FileHash;
